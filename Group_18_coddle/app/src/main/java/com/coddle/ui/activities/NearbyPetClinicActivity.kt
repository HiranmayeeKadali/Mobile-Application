...
import com.coddle.databinding.ActivityNearbyPetClinicBinding
...
class NearbyPetClinicActivity : AppCompatActivity() {
    private lateinit var binding: ActivityNearbyPetClinicBinding
    private var myUrl = "https://www.google.com/maps/search/pet+clinic+near+"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityNearbyPetClinicBinding.inflate(layoutInflater)
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(p0: LocationResult) {
                ...
                val geocoder = Geocoder(this@NearbyPetClinicActivity, Locale.getDefault())
